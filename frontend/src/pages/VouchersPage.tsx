        ...
        <DialogContent sx={{ bgcolor: '#eef1f5', p: { xs: 1, sm: 2 } }}>
          ...
          {printVoucher && (
            printVoucher.voucherType === VoucherType.RECEIPT
              ...
              : printVoucher.voucherType === VoucherType.JOURNAL
                ? <JournalVoucherPrintPreview voucher={printVoucher} template={journalVoucherTemplate} />
                : <PaymentVoucherPrintPreview voucher={printVoucher} template={voucherTemplate} />
          )}
        </DialogContent>
        <DialogActions>
...
type PrintableVoucher = Voucher & { createdByUser?: { name: string } | null };
...
function VoucherPrintSheet({ template, alt, aspect, children }: { template: string; alt: string; aspect: string; children: React.ReactNode }) {
  return <>
    ...
    <Box className="voucher-print-root" sx={{ width: '100%', display: 'flex', justifyContent: 'center', p: { xs: 0, sm: 1 } }}>
      <Box className="voucher-print-sheet" sx={{ position: 'relative', width: '100%', maxWidth: 1100, aspectRatio: aspect, bgcolor: '#fff', boxShadow: 3, overflow: 'hidden' }}>
...
function PaymentVoucherPrintPreview({ voucher, template }: { voucher: PrintableVoucher; template: string }) {
  ...
  return (
    <VoucherPrintSheet template={template} alt="Payment voucher template" aspect="1568 / 1014">
      ...
      <Typography sx={{ ...voucherLineFieldSx, left: '23.2%', top: '57.1%', width: '70%' }}>{voucher.description || ''}</Typography>
...
function ReceiptVoucherPrintPreview({ voucher, template }: { voucher: PrintableVoucher; template: string }) {
  ...
  return (
    <VoucherPrintSheet template={template} alt="Receipt voucher template" aspect="1600 / 1035">
      ...
      <Typography sx={{ ...voucherLineFieldSx, left: '21.8%', top: '57.1%', width: '71.5%' }}>{voucher.description || ''}</Typography>
...
function JournalVoucherPrintPreview({ voucher, template }: { voucher: PrintableVoucher; template: string }) {
