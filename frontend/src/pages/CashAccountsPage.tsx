        ...
        <DialogContent>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1 }}>
            ...
            <TextField
              ...
              InputProps={{ startAdornment: <InputAdornment position="start">₹</InputAdornment> }}
            />
            <TextField label="Date" type="date" value={bankCashForm.date ?? ''} onChange={(e) => setBankCashForm({ ...bankCashForm, date: e.target.value })} size="small" InputLabelProps={{ shrink: true }} />
