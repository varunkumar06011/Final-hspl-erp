...
CREATE INDEX "owner_accounts_projectId_idx" ON "owner_accounts"("projectId");
...
CREATE UNIQUE INDEX "journal_vouchers_jvNumber_key" ON "journal_vouchers"("jvNumber");
CREATE UNIQUE INDEX "journal_vouchers_approvalWorkflowId_key" ON "journal_vouchers"("approvalWorkflowId");
CREATE INDEX "journal_vouchers_projectId_idx" ON "journal_vouchers"("projectId");
...
CREATE INDEX "journal_entries_journalVoucherId_idx" ON "journal_entries"("journalVoucherId");
